...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-surface-50 border-t border-brand-75 flex justify-around items-center pt-3 z-40" style={{ paddingBottom: "max(1.5rem, env(safe-area-inset-bottom))" }}>
        ...
        return (
          <Link
            ...
            className={`flex flex-col items-center gap-0.5 transition-colors ${
              active ? "text-brand-500" : "text-brand-450"
            }`}
          >

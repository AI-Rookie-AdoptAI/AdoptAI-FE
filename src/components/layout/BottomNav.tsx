...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] bg-surface-50 border-t border-brand-75 flex justify-around items-center pb-6 pt-3 z-40">
